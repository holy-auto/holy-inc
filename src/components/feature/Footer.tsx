...
export default function Footer() {
  ...
  return (
    <footer className="text-slate-600 shadow-[inset_0_12px_24px_-16px_rgba(176,162,140,0.7)]">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="pt-2 border-t border-[rgba(176,162,140,0.25)]">
      ...
      {/* Bottom Bar */}
      <div className="border-t border-[rgba(176,162,140,0.25)]">
